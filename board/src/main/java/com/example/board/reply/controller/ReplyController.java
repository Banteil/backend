...
public class ReplyController {
    ...
    public String postRegister(@ModelAttribute("dto") @Valid BoardDTO dto,
    ...
    // log.info("book id : {}", id);
    // BoardDTO dto = bookService.read(id);
    ...
    @PostMapping("/modify")
    public String postModify(@ModelAttribute("dto") @Valid BoardDTO dto,
            BindingResult result,
    ...
    @PostMapping("/remove")
    public String postRemove(@ModelAttribute("dto") @Valid BoardDTO dto, RedirectAttributes rttr) {
        log.info("remove POST 요청 ID: {}", dto.getBno());
        String title = bookService.delete(dto);
    ...
    // Page<BoardDTO> bookPage = bookService.readAll(pageRequestDTO);
    // PageResultDTO<BoardDTO> resultDTO = PageResultDTO.<BoardDTO>withAll()
